...
class Omnimessage implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'dlrUrl' => 'string',
        'textStore' => '\Messente\Omnichannel\Model\TextStore',
        'timeToSend' => '\DateTime'
    ];
     ...
     * Sets to
     *
     * @param string $to Phone number of the recipient in e.164 format
     *
     * @return $this
     */
     ...
     * Gets textStore
     *
     * @return \Messente\Omnichannel\Model\TextStore|null
     */
     ...
     * Sets textStore
     *
     * @param \Messente\Omnichannel\Model\TextStore|null $textStore textStore
     *
     * @return $this
     */
