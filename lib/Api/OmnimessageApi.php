...
class OmnimessageApi
{
     ...
     */
    public function sendOmnimessageAsync($body)
    {
        return $this->sendOmnimessageAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function sendOmnimessageRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sendOmnimessage'
            );
        }
